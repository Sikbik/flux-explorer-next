...
export function PollingControls({
  ...
  return (
    <div className={`flex flex-col sm:flex-row items-start sm:items-center gap-3 p-4 rounded-lg border bg-card ${className}`}>
      ...
      <div className="flex items-center gap-2 ml-auto text-sm text-muted-foreground">
        {polling.isPolling && (
          <span className="flex items-center gap-1">
            ...
            Active ({formatInterval(polling.interval)})
          </span>
        )}
        {!polling.isPolling && (
          <span className="flex items-center gap-1">
