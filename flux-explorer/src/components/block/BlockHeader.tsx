    ...
    <Card>
      <CardContent className="pt-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold">Block #{block.height.toLocaleString()}</span>
            </div>
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <Clock className="h-4 w-4" />
              {blockTime.toLocaleString()} ({formatDistanceToNow(blockTime, { addSuffix: true })})
            </div>
          </div>
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <div className="flex items-center gap-2 rounded-lg bg-muted px-3 py-2 font-mono text-sm flex-1 min-w-0">
            <span className="truncate flex-1" title={block.hash}>{block.hash}</span>
